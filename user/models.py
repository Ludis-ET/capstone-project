...
class Shelf(models.Model):
    ...
    books = models.ManyToManyField('core.Book', related_name='shelves', blank = True, null = True)
...
class Wishlist(models.Model):
    ...
    books = models.ManyToManyField('core.Book', related_name='wishlists', blank = True, null = True)
    added_time = models.DateTimeField(auto_now_add=True)
